...
export default function Login() {
  ...
  const handleGoogleAuth = () => {
    // CRA's dev proxy only works for XHR/fetch — NOT for full browser redirects.
    // window.location must target the backend directly (port 5001 in dev).
        ...
        <div className="stitch-auth-panel-wrap">
          <div className="stitch-auth-card">
            ...
            <div className="stitch-auth-divider">
              <span>Or sign in / sign up with</span>
            </div>
            ...
            <p style={{ textAlign: 'center', marginTop: 8, fontSize: 12, color: 'var(--mid)' }}>
              Are you a provider?{' '}
